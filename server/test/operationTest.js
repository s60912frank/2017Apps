...
describe('帳戶作業', function () {
    ...
    it('儲值成功:token=customerBy00', function (done) {
        chai.request(app)
            .put(`${storePath}/account`)
            .send({ _id: customer._id, amount: 1000 })
    ...
    it('權限錯誤:token=managerBy00', function (done) {
        chai.request(app)
            .put(`${storePath}/account`)
